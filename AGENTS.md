...
- emblem
- diamondQuality (stored as request/quote metadata; not a major prompt control)
...
6. ~~**Add `diamondQuality`** to the `Request` model and POST body.~~ **Done.** It is stored as request/quote metadata.
