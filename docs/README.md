...
4. Update `agent-context.md` when route visibility, workflow preferences, prompt-generation guardrails, or known pitfalls change.
5. Keep historical design files intact unless their purpose changes. Add a note instead of rewriting old implementation history.
